...
2. If missing, run cold-start / `--init` — do not invent a firm name.  
3. Client workspaces remain under the engagement folder; firm profile is **practice-wide**.  
4. Never write client figures into the firm profile.
