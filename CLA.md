...
To the maximum extent permitted by law, you waive (or agree not to assert) moral rights in your contributions against the project and its users for uses permitted by the license.

## How to sign

On your first pull request, reply with:

```text
I have read the CLA Document and I hereby sign the CLA
```

You only need to do this once per contributor identity unless the CLA text changes materially.
