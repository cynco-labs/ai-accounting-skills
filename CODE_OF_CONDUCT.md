...
* Care with financial and client data — never post real client information in issues or PRs.
...
* Uploading client working papers, bank statements, or tax files to the repository.
